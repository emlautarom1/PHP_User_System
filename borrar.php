			...
			<div id="header" class="container">
				...
				<div id="menu">
					<ul>
						...
						<li class="current_page_item"><a href="borrar.php">eliminar</a></li>
					</ul>
				</div>
			</div>
						...
						<?php 
							if($_SERVER["REQUEST_METHOD"] == "POST"){
								...
								if (!empty($toDelete)){	
									...
									// Gets # of deleted users
									$n_deleted = count($toDelete);
									// Resets all deletes
									unset($_POST['delete']);
									// Alert box
									print("
									<script language=\"javascript\">
									alert(\"Se han eliminado $n_deleted usuario(s) del sistema.\")
									</script>
									");
								}
							}
